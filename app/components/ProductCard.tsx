...
const ProductCard: React.FC<CardProps> = ({ image, name, brand, price, hasDiscount, discount, newPrice, rating, id }) => {
      const router = useRouter();

    return (
        <Card key={id} className="flex flex-col h-[300px] md:h-[481px] gap-6 relative cursor-pointer"  onClick={() =>router.push(`/product/${id}`) } >
